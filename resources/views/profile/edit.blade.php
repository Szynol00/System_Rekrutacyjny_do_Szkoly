...
<body>
    ...
    <div class="container">
        <div class="card mt-5 mb-5">
            ...
            <div class="card-body">
                <form id="user_form" action="{{ route('profile.update', $user->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <span id="photoError" class="form-text text-danger"></span>
                            </div>
                        ...
                        <div class="col-md-8">
                            ...
                            @if ($user->role_id == 2)
                                <div class="exam-info">
                                    <div class="mb-3">
                                        <label for="mathematics_score" class="form-label">Wynik z matematyki:</label>
                                        <input type="text" class="form-control" id="mathematics_score"
                                            name="mathematics_score" value="{{ $user->candidate->mathematics_score }}"
                                            required>
                                        <span id="mathematics_score_error" class="form-text text-danger"></span>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <span id="polish_score_error" class="form-text text-danger"></span>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <span id="english_score_error" class="form-text text-danger"></span>
                                    </div>
...
<script>
    document.getElementById('user_form').addEventListener('submit', function(event) {
        ...
        var mathScoreInput = document.getElementById('mathematics_score');
        var mathScoreError = document.getElementById('mathematics_score_error');
